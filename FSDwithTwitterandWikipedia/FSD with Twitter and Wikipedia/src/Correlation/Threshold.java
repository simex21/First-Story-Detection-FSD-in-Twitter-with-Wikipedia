...
public class Threshold {
	...
	public double mad(double [] autoCorrelationValues){
		...
		for(int i=0 ; i<autoCorrelationValues.length ;i++){
			//System.out.println("autocorrelationvalues: "+autoCorrelationValues[i]);
	...
	public double theta1(double [] autoCorrelationValues, double gama){
		Median m = new Median();
		System.out.println("m.evaluate: "+m.evaluate(autoCorrelationValues));
		System.out.println("mad of autocorrelationvalues: "+mad(autoCorrelationValues));

...
//computeCrossCorrelation
	...
	public void run() {
	    ...
	    for(int i = 0; i < partKeyWords.size(); i++){
	        ...
	        //System.out.println("For i = "+i+" "+autoCorrelationValues[i]);
	    }
		...
		System.out.println("length of bigMatrix is: "+bigMatrix.length);
	    //compute theta2 using the bigmatrix
		//My modification
		if(bigMatrix.length!=0){
		...
		try {
		    ...
		    for(Event ev : events){
		    	System.out.println(ev.getEpsylon());
